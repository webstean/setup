...
Requirement: Create a PowerShell function Using PnP.PowerShell that takes a PnP Connection and a site url, looks for any SharePoint Group [sitename] Members
in that have site that have the 'edit' permission and change that permission to 'contribute'.
